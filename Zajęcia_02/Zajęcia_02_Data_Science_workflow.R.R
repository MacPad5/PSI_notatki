...
# 2.2.4 Porządkowanie braków danych ----
...
#  2.3 Łączenie (scalanei) ramek danych w jedną ----
...
# 2.4 podstawowwa analiza dancyh ----
...
# 2.4.2 mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
# 2.4.3 filter() – wybieranie wierszy ----
...
# 2.4.4 select() – wybieranie kolumn ----
...
# 2.4.7 summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
